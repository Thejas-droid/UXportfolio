...
export const BOOT_KEY = "thejas.sys.booted";

const LINES = [
  { t: `${profile.name} — ${profile.role}`, c: "title" },
  { t: "Loading portfolio...", c: "info" },
  { t: "Loading projects...", c: "ok" },
  { t: "Loading contact details...", c: "ok" },
  { t: "READY.", c: "ready" },
];
