...
const COUNTER_KEY = "thejas.sys.visitor";
const QUOTES = [
...
function useVisitorCount() {
  ...
  useEffect(() => {
    try {
      ...
      const next = prev > 0 ? prev + 1 : seed + 1;
    ...
    <aside className="hidden lg:flex flex-col gap-3 w-64 shrink-0" aria-label="Site sidebar">
      <BeveledPanel title="visitors.log">
        <div className="font-mono text-center">
          <div className="text-retro-fg-dim text-xs">Visits on this device:</div>
      ...
      <BeveledPanel title="webring.html">
        <ul className="text-sm space-y-1 font-mono">
          <li>
            ◀ <ProfileLink href={profile.socials.github} target="_blank" rel="noreferrer">GitHub</ProfileLink>
          </li>
          <li>
            ● <ProfileLink href={profile.socials.linkedin} target="_blank" rel="noreferrer">LinkedIn</ProfileLink>
          </li>
          <li>
            ▶ <ProfileLink href={emailHref}>/usr/mail</ProfileLink>
          </li>
          <li>
