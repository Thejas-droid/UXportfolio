...
const Timeline = () => {
  useSeoMeta({
    title: "Timeline",
    description: "Thejas S's career log — education, work history, and key milestones in software development.",
    path: "/timeline",
  });
  return (
  <div className="space-y-4 py-2">
    <BeveledPanel title="career.log — /var/log/thejas/career.log">
      <div className="font-mono text-xs text-retro-fg-dim mb-2 px-2">
        $ tail -f /var/log/thejas/career.log
      </div>
